...
export default function AdminReview() {
  ...
  const chartData = [
    ...
    { name: "Approved", value: overall.approved ?? 0 },
    { name: "Rejected", value: overall.rejected ?? 0 },
  ];
    ...
    <div className="page">
      ...
      {panel && (
        <div
          ...
          onClick={(e) =>
            e.target === e.currentTarget && setPanel(null)
          }
        >
              ...
              <Card>
                <div className="card-head between">
                  ...
                  <div className="score-display">
                    {panel.scoring?.mlResponse?.label && (
                      <Pill
                        tone={
                          panel.scoring.mlResponse.label === "Fraud"
                            ? "danger"
                            : "good"
                        }
                      >
                    ...
                    {typeof panel?.scoring?.mlResponse?.probability ===
                      "number" && (
                      <span className="score-value">
                        {(
                          panel.scoring.mlResponse.probability * 100
                        ).toFixed(1)}
                        %
                      </span>
                    )}
                ...
                {panel.scoring?.mlResponse && (
                  <>
                    ...
                    {/* Top Features */}
                    {panel.scoring.mlResponse.topFeatures &&
                      panel.scoring.mlResponse.topFeatures.length > 0 && (
                        <div className="mt">
                          <div className="muted mb-xs">
                            Top Contributing Features
                          </div>
                          <div className="feature-list">
                            {panel.scoring.mlResponse.topFeatures.map(
                              (feature, idx) => (
                                <div
                                  key={idx}
